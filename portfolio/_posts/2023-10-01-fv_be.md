...
From a design and coordination perspective, I operated as the user liaison and domain expert for the entire full-stack web application, designing user-side acceptance criteria for the MVP launch and subsequent features over the next 10 months.
